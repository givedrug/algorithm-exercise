...
public class No876 {
    ...
    public static void main(String[] args) {
        // [3,4,5]
        printListNode((middleNode(strToListNode("[1,2,3,4,5]"))));
        // [4,5,6]
        printListNode((middleNode(strToListNode("[1,2,3,4,5,6]"))));
        // [2]
        printListNode((middleNode(strToListNode("[1,2]"))));
        // [1]
        printListNode((middleNode(strToListNode("[1]"))));
        // []
        printListNode((middleNode(strToListNode("[]"))));
    }
